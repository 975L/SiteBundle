...
# Lizard is a Python tool, and it is pinned where the PHP tools above take their latest release: its counting changed between versions and this is the one Codacy runs, which the thresholds composer.json hands it are read against
