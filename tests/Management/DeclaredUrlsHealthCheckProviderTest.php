...
class DeclaredUrlsHealthCheckProviderTest extends TestCase
{
    ...
    private function createAnalyzer(?array $analysis = null, ?int $status = null, ?PageExistenceChecker $checker = null): ContentQualityAnalyzer
    {
        return new ContentQualityAnalyzer(
            ...
            $this->createStub(PageBlockLocator::class),
    ...
    {
        $checker = $this->createMock(PageExistenceChecker::class);
